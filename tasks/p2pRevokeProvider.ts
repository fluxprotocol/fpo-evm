...
// npx hardhat p2pRevokeProvider --network kovan --contract 0x486e84a4a7A0865D65d39470165EfDD980DA0700 --provider 0xD8FC00c7fe6e9a12d701192595abF425A6546E9A

task("p2pRevokeProvider", "Submits an answer to factoryPriceFeed")
  ...
  .setAction(async (_taskArgs, hre) => {
    ...
    const tx = await contract.connect(admin).revokeRole(validatorRole, _taskArgs.provider);
